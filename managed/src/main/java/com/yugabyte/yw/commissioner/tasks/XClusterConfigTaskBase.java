...
public abstract class XClusterConfigTaskBase extends UniverseDefinitionTaskBase {
  ...
  protected SubTaskGroup createXClusterConfigSetupTask(List<String> tableIds) {
  ...
  protected SubTaskGroup createXClusterConfigModifyTablesTask(
      List<String> tableIdsToAdd, List<String> tableIdsToRemove) {
    SubTaskGroup subTaskGroup =
  ...
  /**
   * It returns a list of tables that xCluster replication cannot be setup for them and need
   * bootstrap.
   *
   ...
   *
   * @return A list of tables that need to be bootstrapped
   * @see #createCheckBootstrapRequiredTask()
   */
  protected List<XClusterTableConfig> getTablesNeedBootstrap() {
    return taskParams()
        .xClusterConfig
        .tables
        .stream()
  ...
  /**
   * It returns a list of tables that xCluster replication can be set up without bootstrapping.
   *
   * @return A list of tables that need to be bootstrapped
   * @see #getTablesNeedBootstrap()
   */
  protected List<XClusterTableConfig> getTablesNotNeedBootstrap() {
    return taskParams()
        .xClusterConfig
        .tables
        .stream()
   ...
   */
  protected SubTaskGroup createBootstrapProducerTask(List<String> tableIds) {
    ...
    bootstrapProducerParams.tableIds = tableIds;
   ...
   *     happened for them
   */
  protected SubTaskGroup createSetRestoreTimeTask(List<String> tableIds) {
